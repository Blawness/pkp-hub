...
export async function proxy(request: NextRequest) {
  ...
  // dan `/portal` sudah memasang gerbang area (`requireUser` + `homeForRole`)
  // yang membelokkan berdasarkan role dari DB. Gerbang ini boleh melewatkan,
  // tidak boleh salah menolak.
  //
