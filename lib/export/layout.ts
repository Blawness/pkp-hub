 ...
 *
 * Lebar teks dalam titik dihitung dari `charWidth * len` (aproksimasi font
 * monospace-ish). `maxWidth` adalah sisa lebar kolom. Kalau teks muat,
 * kembalikan apa adanya. Kalau lewat, potong karakter dari belakang sampai
 * `text + ellipsis` muat, lalu tambahi `ellipsis`.
 */
